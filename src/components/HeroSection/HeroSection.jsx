...
const HeroSection = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="lg:bg-gradient-to-b bg-gradient-to-b from-blue-600 via-indigo-600 to-purple-600 text-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-700">
